...
// code by muh iriansyah putra pratama
          $query = $conn->prepare("SELECT * FROM team WHERE id  =:id ");
...
// code by muh iriansyah putra pratama
          try {
      			...
      			$updatedata = array(':nama_club' => $club, ':alamat' => $alamat, ':tahun_berdiri' => $tahun,  ':image' => $image,
...
// code by muh iriansyah putra pratama
			try {
				...
				$updatedata = array(':nama_club' => $club, ':alamat' => $alamat, ':tahun_berdiri' => $tahun,  ':id' => $id);
				$pdo->execute($updatedata);
