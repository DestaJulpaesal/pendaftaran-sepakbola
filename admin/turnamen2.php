    ...
    <header class="d-flex justify-content-between my-4">
        ...
        <form action="turnamen3.php" method="post">
            <div class="form-elemnt my-4">
                <input type="text" class="form-control" name="nama_turnamen" placeholder="Nama Turnamen :">
            </div>
            <div class="form-elemnt my-4">
                <input type="date" class="form-control" name="tanggal_mulai" placeholder="Tangga Mulai :">
            </div>
            ...
            <div class="form-element my-4">
                <input type="submit" name="create" value="Tambah Turnamen" class="btn btn-primary">
            </div>
        </form>
